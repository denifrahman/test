                            ...
                            <form method="POST" action="">
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="footer text-center">
                                        <input type="submit" name="login" class="btn btn-primary btn-wd btn-lg" value="Daftar" />
                                        <a href="login"><input name="login" class="btn btn-primary btn-wd btn-lg" value="Kembali" /></a>
                                    </div>
                                </div>
                            </form>
                        </div>
