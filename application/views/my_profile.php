	                                        ...
	                                        <div class="row">
			                                    <div class="col-sm-12">
								            		<div class="form-group label-floating label-static">
						                                ...
						                                <input class="form-control" name="role" id="role_save" type="hidden" required="true" value="undefined" />
								                    </div>
								                    <div class="row">
						                                <div class="col-sm-6">
										                    <div class="form-group label-floating label-static">
						                            ...
						                            <div class="text-right">
					                                	<button type="button" class="btn btn-success btn-fill" name="submit" onclick="saveUser()">Simpan</button>
