...
class Master_jenis_kategori extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('M_jenis_kategori'); 
	...
	{
		$data['m_penyakit'] = $this->M_jenis_kategori->get_all_jenis_kategori();
		$data['header'] = 'header';
		$data['menu'] = 'menu';
		$data['script'] = 'script';
		$data['footer'] = 'footer';
		// var_dump($data);
		$this->load->view('master_jenis_kategori', $data);
	}
