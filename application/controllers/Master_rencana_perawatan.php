...
class Master_rencana_perawatan extends CI_Controller {
	...
	function add_rencana_perawatan(){
		...
		$result = array();
			...
			$data['add_rencana_perawatan'] = $this->m_master_rencana_perawatan->add_rencana_perawatan($nama);
  ...
  //  					);
	...
	function edit_rencana_perawatan(){
		...
		// 	if(!$cek_nama || $nama != $nama_lama){
				...
				$data['add_rencana_perawatan'] = $this->m_master_rencana_perawatan->edit_rencana_perawatan($id, $nama);
