...
var loaded = function loaded() {
  ...
  getKategoriPenyakit(); // $('#fomrMasterPenyakit input').on('keyup blur', function () {
...
var addRencanaPerawatan = function addRencanaPerawatan() {
  clearModal();
  unsetFormValidation();
...
function saveRencanaPerawatan() {
  ...
  if (!$valid) {
    ...
    $('#myModal').modal('hide'); // console.log("select2: ", $("#id_kategori_penyakit").val());
